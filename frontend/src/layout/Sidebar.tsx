...
function Sidebar() {
  ...
  const RTL = false; // Replace with your logic
  const t = (key: string) => key; // Replace with your i18n
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 ${RTL ? "right-0" : "left-0"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-2  bg-cover bg-center bg-blend-overlay">
          ...
          <div className={`absolute bottom-10 ${RTL ? "right-3" : "left-3"}`}>
            <button
